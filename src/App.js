  ...
  render: function() {
    return (
      <div className="UserProfile">
        <div className="User">
          <div className="name">Giga Dev</div>
          {/* <div className="image"><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/557257/profile/profile-512_1.jpg" alt="profile" /></div> */}
          <div className="image"><img src="https://drive.google.com/file/d/1E2GzlvQ94V9i4WO-WjLKrnYc-SVl1oZF/view?usp=sharing" alt="profile" /></div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div id="hero" className="Hero" style={{backgroundImage: 'url(https://images.alphacoders.com/633/633643.jpg)'}}>
        <div className="content">
          ...
          <h2>Movie list</h2>
          <p>Welcome to a simple web app I built using ReactJS.</p>
...
var TitleList = React.createClass({
  ...
  loadContent: function() {
    var requestUrl = 'https://api.themoviesdb.org/3/' + this.props.url + '&api_key=' + this.apiKey;
